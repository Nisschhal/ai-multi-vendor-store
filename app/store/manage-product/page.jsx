...
export default function StoreManageProducts() {
  ...
  const toggleStock = async (productId) => {
    try {
      ...
      console.log("Error toggling stock:", error)
      toast.error(error?.response?.data?.message || "Failed to toggle stock")
    }
  }
                  ...
                  <input
                    ...
                    onChange={() =>
                      toast.promise(toggleStock(product.id), {
                        loading: `Toggling stock for ${product.name}...`,
                      })
                    }
